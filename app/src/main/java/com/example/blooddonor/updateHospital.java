...
public class updateHospital extends AppCompatActivity implements AdapterView.OnItemSelectedListener,Validator.ValidationListener {
    ...
    public void onValidationSucceeded() {
        if(state.isEmpty() || state.equalsIgnoreCase("State") ){
            displayMessage("State Is Not Selected");
        }else{
            retrieveContents();
